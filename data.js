const DB = {
  config: {
    ...
    defaultTC: 20, // Tipo de cambio default
    logoName: "ALX GRAPHX",
  ...
  services: [
    // Branding
    { cat: 'branding', name: 'Identidad de marca básica', desc: 'Logotipo + paleta de color + tipografía + manual básico de uso.', hrs: 20, price: 350, includes: ['Investigación y brief', 'Conceptualización (2 propuestas)', 'Diseño final', '2 revisiones incluidas', 'Archivos listos para uso'] },
    ...
    { cat: 'ilustracion_proyecto', name: 'Ilustración editorial', desc: 'Para artículos, libros o medios digitales con enfoque narrativo.', hrs: 10, price: 20, includes: ['Brief y referencias', 'Arte final en alta resolución', '2 revisiones'] },
    ...
    // Fotografía
    { cat: 'fotografia', name: 'Sesión fotográfica (hasta 2h)', desc: '30 fotos editadas entregadas.', hrs: 10, includes: ['Sesión presencial', '30 fotos editadas', 'Galería digital'] },
